...
const defenceTypePage = require('./pages/respondToClaimLRspec/defenceType.page');
const freeMediationPage = require('./pages/respondToClaimLRspec/freeMediation.page');
const chooseCourtSpecPage = require('./pages/respondToClaimLRspec/chooseCourtLRspec.page');
const smallClaimsHearingPage = require('./pages/respondToClaimLRspec/hearingSmallClaims.page');
const useExpertPage = require('./pages/respondToClaimLRspec/useExpert.page');
