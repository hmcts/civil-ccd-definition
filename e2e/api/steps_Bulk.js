...
const data = {
  ...
  CREATE_BULK_CLAIM_VIA_CIVILSERVICE: (scenario, pbaV3) => claimDataBulk.createClaimBulk(scenario, pbaV3),
...
module.exports = {
  ...
  createNewClaimWithCaseworkerCivilService: async (user, scenario) => {
    eventName = 'CREATE_CLAIM_SPEC';
    caseId = null;
    caseData = {};
    let createClaimData  = {};

    createClaimData = data.CREATE_BULK_CLAIM_VIA_CIVILSERVICE(scenario);
    await apiRequest.setupTokens(user);
