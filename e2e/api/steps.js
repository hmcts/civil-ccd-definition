...
const data = {
  ...
  INFORM_AGREED_EXTENSION_DATE: require('../fixtures/events/informAgreeExtensionDate.js').agreedData,
  INFORM_AGREED_EXTENSION_DATE_SOLICITOR_TWO: require('../fixtures/events/1v2DifferentSolicitorEvents/informAgreeExtensionDate_Solicitor2.js').agreedData,
...
module.exports = {
  ...
  informAgreedExtension: async (user, multipartyScenario, solicitor) => {
    ...
    if (mpScenario !== 'ONE_V_TWO_TWO_LEGAL_REP') {
      informAgreedExtensionData = await eventData['informAgreedExtensionDates'][mpScenario]();
    } else {
      informAgreedExtensionData = await eventData['informAgreedExtensionDates'][mpScenario][solicitor]();
    }
