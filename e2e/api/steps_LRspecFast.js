...
const data = {
  ...
  DEFENDANT_RESPONSE: (response, mpScenario) => require('../fixtures/events/defendantResponseSpecSmall.js').respondToClaim(response, mpScenario),
...
const eventData = {
  defendantResponses: {
    ONE_V_ONE: {
      FULL_DEFENCE: data.DEFENDANT_RESPONSE('FULL_DEFENCE', 'ONE_V_ONE'),
      FULL_ADMISSION: data.DEFENDANT_RESPONSE('FULL_ADMISSION', 'ONE_V_ONE'),
      PART_ADMISSION: data.DEFENDANT_RESPONSE('PART_ADMISSION', 'ONE_V_ONE'),
      COUNTER_CLAIM: data.DEFENDANT_RESPONSE('COUNTER_CLAIM', 'ONE_V_ONE')
    },
    ONE_V_TWO: {
