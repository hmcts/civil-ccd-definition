...
module.exports = {
  ...
  appendDate: (date = new Date(), day, month, year) => {
    const newDate = new Date(date);
    newDate.setDate(day ? day : date.getDay());
    newDate.setMonth(month ? month : date.getMonth());
    newDate.setYear(month ? year : date.getYear());
    return newDate;
  },
