...
module.exports = {
  ...
  url: {
    manageCase: process.env.URL || 'https://xui-civil-ccd-pr-352.service.core-compute-preview.internal',
    ...
    civilService: process.env.CIVIL_SERVICE_URL || 'http://civil-ccd-pr-352.service.core-compute-preview.internal',
  },
  s2s: {
