...
module.exports = {
  ...
  url: {
    ...
    // waTaskMgmtApi: process.env.WA_TASK_MGMT_URL || 'http://wa-task-management-api-demo.service.core-compute-demo.internal'
      ...
      manageCase: 'https://xui-civil-ccd-pr-1541.service.core-compute-preview.internal',
      authProviderApi:'http://rpe-service-auth-provider-aat.service.core-compute-aat.internal',
      ccdDataStore: 'https://ccd-data-store-api-civil-ccd-pr-1541.service.core-compute-preview.internal',
      dmStore: 'http://dm-store-aat.service.core-compute-aat.internal',
      idamApi: 'https://idam-api.aat.platform.hmcts.net',
      civilService: 'https://civil-ccd-pr-1541.service.core-compute-preview.internal'
  },
  s2s: {
