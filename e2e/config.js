...
module.exports = {
  ...
  url: {
    ...
    // for preview
    // manageCase: 'https://xui-civil-ccd-pr-4295.preview.platform.hmcts.net',
    // authProviderApi: process.env.SERVICE_AUTH_PROVIDER_API_BASE_URL || 'http://rpe-service-auth-provider-demo.service.core-compute-demo.internal',
    // ccdDataStore: 'https://ccd-data-store-api-civil-ccd-pr-4295.preview.platform.hmcts.net',
    // dmStore: 'http://dm-store-aat.service.core-compute-aat.internal',
    // idamApi: 'https://idam-api.aat.platform.hmcts.net',
    // civilService: 'https://civil-ccd-pr-4295.preview.platform.hmcts.net',
