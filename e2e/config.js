...
module.exports = {
  ...
  url: {
    manageCase: process.env.URL || 'https://xui-civil-ccd-pr-5224.service.core-compute-preview.internal',
    ...
    ccdDataStore: process.env.CCD_DATA_STORE_URL || 'https://ccd-data-store-api-civil-ccd-pr-5224.preview.platform.hmcts.net',
    ...
    civilService: process.env.CIVIL_SERVICE_URL || 'https://civil-ccd-pr-5224.preview.platform.hmcts.net',
