...
//    for Preview
   manageCase: 'https://xui-civil-service-pr-6918.preview.platform.hmcts.net',
   authProviderApi: 'http://rpe-service-auth-provider-aat.service.core-compute-aat.internal',
   ccdDataStore: 'https://ccd-data-store-api-civil-service-pr-6918.preview.platform.hmcts.net',
   dmStore: 'http://dm-store-aat.service.core-compute-aat.internal',
   idamApi: 'https://idam-api.aat.platform.hmcts.net',
   civilService: 'https://civil-service-pr-6918.preview.platform.hmcts.net',
   caseAssignmentService: 'http://manage-case-assignment-civil-service-pr-6918.preview.platform.hmcts.net',
   generalApplication: 'https://ga-civil-service-pr-6918.preview.platform.hmcts.net',
