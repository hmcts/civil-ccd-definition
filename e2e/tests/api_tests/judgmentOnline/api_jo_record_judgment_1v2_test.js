...
Scenario('1v2 full defence unspecified - caseworker records judgment (Det.of means - pay instalments) and set aside judgment @api-unspec @api-tests-1v2 @api-jo @api-non-prod-jo', async ({api}) => {
  if (['preview', 'demo'].includes(config.runningEnv)) {
    ...
    await api.setAsideJudgment(legalAdvUser);
  }
});
