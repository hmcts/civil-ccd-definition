...
Feature('Unspec 1v1 api Other Remedy default judgment journey').tag('@civil-service-nightly @api-other-remedy-dj @raja');

let caseId;

Scenario.only('01 Default Judgment claim', async ({I, api}) => {
