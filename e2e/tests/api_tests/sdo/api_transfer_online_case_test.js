...
Feature('Transfer Online Case 1v2 API test - fast claim - unspec @api-unspec @api-tests-1v2SS @api-prod @api-nonprod');
...
Feature('Transfer Online Case 1v2 API test - small claim - spec @api-spec-1v2 @api-prod @api-nonprod');
