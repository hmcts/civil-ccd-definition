...
//   await api.addDefendantLitigationFriend(config.defendantSolicitorUser, mpScenario, 'solicitorOne');
// });
//
...
// Scenario('Update applicant details', async ({api}) => {
//   await api.manageContactInformation(config.adminUser);
// });
//
