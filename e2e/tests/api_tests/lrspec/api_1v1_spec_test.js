...
Scenario('1v1 full admit', async ({I, api_spec}) => {
  ...
  await api_spec.createClaim(config.applicantSolicitorUser,
    require('../../../fixtures/events/createClaimSpec.js').createClaimDataByPage('ONE_V_ONE')
  );
  await api_spec.defendantResponse(config.defendantSolicitorUser, 'FULL_ADMISSION');
  // await api_spec.defendClaim(config.applicantSolicitorUser,
  //   require('../../../fixtures/events/defendantResponseSpec.js').respondToClaimDataByPage('FULL_ADMISSION'),
