...
Scenario('1v1 full defence claimant and defendant response @api-prod-specified @api-sher2', async ({I, api_spec}) => {
  await api_spec.createClaimWithRepresentedRespondent(config.applicantSolicitorUser);
...
//     'AWAITING_APPLICANT_INTENTION');
// });
//src/main/java/uk/gov/hmcts/reform/civil/handler/callback/user/ManageContactInformationCallbackHandler.java
