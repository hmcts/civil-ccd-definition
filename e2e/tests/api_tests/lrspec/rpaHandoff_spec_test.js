...
Scenario('Defendant response and claimant intention - 1v1 Full admission', async ({I, api_spec}) => {
...
Scenario('Defendant response and claimant intention - 1v1 Part admission', async ({I, api_spec}) => {
...
Scenario('Defendant response  - 1v1-counter claim', async ({I, api_spec}) => {
