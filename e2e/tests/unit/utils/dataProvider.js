...
const exclusions = new Map([
  ...
  ['prod', ['UserProfile.json','-nonprod.json','-COS-nonprod.json','GAspec.json','DJ.json','DJspec.json','DJ-SDO-nonprod.json','DJ-nonprod.json','-HNL-nonprod.json','CUI.json','CUI-nonprod.json']],
