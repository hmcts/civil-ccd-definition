...
Scenario('1v2 two respondents are LIP - notify/notify claim details journey', async ({I, api, loginAs}) => {
...
Scenario('1v2 - one LIP and one LR - notify/notify claim details journey', async ({I, api, loginAs}) => {
  civilCaseReference = await api.createClaimWithRespondentLitigantInPerson(config.applicantSolicitorUser,
