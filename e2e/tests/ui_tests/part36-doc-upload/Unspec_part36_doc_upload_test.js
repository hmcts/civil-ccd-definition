...
Feature('1v2DS fast track and upload part36 doc')
  .tag('@civil-ccd-nightly @ui-part36-upload');
...
Scenario('03 Claimant solicitor uploads part36', async ({I}) => {
  await I.login(config.applicantSolicitorUser);
  await I.evidenceUpload(caseNumber, false, false, false, false, 'part36');
}).retry(2);
