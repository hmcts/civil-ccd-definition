...
Feature('Settle this Claim - Confirm marking as paid in full - 2v1 - spec @e2e-nightly-prod e2e-nightly-nonprod');
...
Feature('Settle this Claim - Reason for settlement - judges order - 2v1 - spec @e2e-nightly-prod e2e-nightly-nonprod');
...
Feature('Settle this Claim - Reason for settlement - Consent order - 2v1 - spec @e2e-nightly-prod e2e-nightly-nonprod');
