...
Feature('Settle this Claim - Confirm marking as paid in full - 1v2 - spec @master-e2e-ft @e2e-settle-discontinue e2e-nightly-nonprod');
...
Feature('Settle this Claim - Reason for settlement - judges order - 1v2 - spec @master-e2e-ft @e2e-settle-discontinue e2e-nightly-nonprod');
...
Feature('Settle this Claim - Reason for settlement - Consent order - 1v2 - spec @master-e2e-ft @e2e-settle-discontinue e2e-nightly-nonprod');
