declare global {
  namespace NodeJS {
    interface ProcessEnv {
      ...
      PLAYWRIGHT_RUN_EXUI_USER_DATA_SETUP: string;
      ...
      PLAYWRIGHT_TEST_RESULTS_DIR: string;
      PLAYWRIGHT_BOOTSTRAP_TEST_RESULTS_DIR: string
      ...
      PLAYWRIGHT_PR_FT_GROUPS: string;
