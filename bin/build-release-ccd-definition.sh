...
if [ ${environment} == preview ]; then
   excludedFilenamePatterns="-e *-nonprod.json,*GAspec.json,*DJ.json,*DJspec.json,*DJ-SDO-nonprod.json,*DJ-nonprod.json,*-SDO-HNL-nonprod.json,*CUI.json,*CUI-prod.json"
