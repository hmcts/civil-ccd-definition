...
if [ ${environment} == preview ]; then
   excludedFilenamePatterns="-e *-prod.json,*HNL-nonprod.json,*CUI.json,*CUI-nonprod.json,*-GAR2GAspec-nonprod.json,-e UserProfile.json,*CategoriesDisclosure-nonprod.json,*CategoriesExpert-nonprod.json,*CategoriesTrial-nonprod.json,*CategoriesWitness-nonprod.json"
