...
if [ ${environment} == preview ]; then
  ...
  excludedFilenamePatterns="-e UserProfile.json,*-nonprod.json,*GAspec.json,*-GAR2GAspec-nonprod.json,*DJ.json,*DJspec.json,*DJ-SDO-nonprod.json,*DJ-nonprod.json,*-SDO-HNL-nonprod.json,*CUI.json,*CUI-prod.json"
else
  excludedFilenamePatterns="-e UserProfile.json,*GAspec.json,*-GAR2GAspec-nonprod.json,*-prod.json,*DJ.json,*DJspec.json,*-SDO-HNL-nonprod.json,*CUI.json,*CUI-prod.json"
fi
