...
if [ ${environment} == preview ]; then
   ...
   #excludedFilenamePatterns="-e *-prod.json,*-SDO-nonprod.json,*-base-nonprod.json,*CUI.json,*CUI-nonprod.json,*CUI-prod.json"
  ...
  excludedFilenamePatterns="-e UserProfile.json,*-nonprod.json,*GAspec.json,*DJ.json,*DJspec.json,*DJ-SDO-nonprod.json,*DJ-nonprod.json,*HNL-nonprod.json,*CUI.json,*CUI-prod.json"
else
  excludedFilenamePatterns="-e UserProfile.json,*GAspec.json,*-prod.json,*DJ.json,*DJspec.json,*HNL-nonprod.json,*CUI.json,*CUI-prod.json"
fi
