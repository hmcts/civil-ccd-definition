...
if [ ${environment} == preview ]; then
   excludedFilenamePatterns="-e *-prod.json,*ClaimantResponseLRspec-nonprod.json"
elif [ ${environment} == demo ]; then
  excludedFilenamePatterns="-e UserProfile.json,*-prod.json,*ClaimantResponseLRspec-nonprod.json"
  ...
  excludedFilenamePatterns="-e UserProfile.json,*-nonprod.json,*GAspec.json,*CUI.json,*ClaimantResponseLRspec-nonprod.json"
