...
./bin/utils/organisational-role-assignment.sh "ga_nbc_team_leader_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "nbc-team-leader" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,access_requests"}' "ADMIN"
./bin/utils/organisational-role-assignment.sh "ga_nbc_team_leader_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "national-business-centre" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,access_requests"}' "ADMIN"
./bin/utils/organisational-role-assignment.sh "ga_nbc_team_leader_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "task-supervisor" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,access_requests"}' "ADMIN"
./bin/utils/organisational-role-assignment.sh "ga_nbc_team_leader_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "case-allocator" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,access_requests"}' "ADMIN"
./bin/utils/organisational-role-assignment.sh "ga_nbc_team_leader_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "hmcts-admin" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,access_requests"}' "ADMIN"

./bin/utils/organisational-role-assignment.sh "ga_nbc_admin_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "national-business-centre" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,access_requests"}' "ADMIN"
./bin/utils/organisational-role-assignment.sh "ga_nbc_admin_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "hearing-manager" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,access_requests"}' "ADMIN"
./bin/utils/organisational-role-assignment.sh "ga_nbc_admin_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "hearing-viewer" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,access_requests"}' "ADMIN"
./bin/utils/organisational-role-assignment.sh "ga_nbc_admin_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "hmcts-admin" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,access_requests"}' "ADMIN"

./bin/utils/organisational-role-assignment.sh "ga_tribunal_legal_caseworker_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "hmcts-legal-operations" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,access_requests"}' "LEGAL_OPERATIONS"
./bin/utils/organisational-role-assignment.sh "ga_tribunal_legal_caseworker_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "hearing-manager" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,access_requests"}' "LEGAL_OPERATIONS"
./bin/utils/organisational-role-assignment.sh "ga_tribunal_legal_caseworker_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "hearing-viewer" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,access_requests"}' "LEGAL_OPERATIONS"
./bin/utils/organisational-role-assignment.sh "ga_tribunal_legal_caseworker_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "tribunal-caseworker" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,access_requests"}' "LEGAL_OPERATIONS"

./bin/utils/organisational-role-assignment.sh "ga_ctsc_team_leader_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "ctsc" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work"}' "CTSC"
./bin/utils/organisational-role-assignment.sh "ga_ctsc_team_leader_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "hmcts-ctsc" '{"jurisdiction":"CIVIL","primaryLocation":"420219"}' "CTSC"
./bin/utils/organisational-role-assignment.sh "ga_ctsc_team_leader_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "hearing-viewer" '{"jurisdiction":"CIVIL","primaryLocation":"420219"}' "CTSC"
./bin/utils/organisational-role-assignment.sh "ga_ctsc_team_leader_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "task-supervisor" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,hearing_work,access_requests"}' "CTSC"
./bin/utils/organisational-role-assignment.sh "ga_ctsc_team_leader_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "case-allocator" '{"jurisdiction":"CIVIL","primaryLocation":"420219"}' "CTSC"
./bin/utils/organisational-role-assignment.sh "ga_ctsc_team_leader_national@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "ctsc-team-leader" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"routine_work,access_requests"}' "CTSC"
