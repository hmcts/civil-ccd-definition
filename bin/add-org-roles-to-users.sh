...
./bin/utils/organisational-role-assignment.sh "hearing_center_admin_reg1@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "hearing-centre-admin" '{"jurisdiction":"CIVIL","primaryLocation":"20262","workTypes":"hearing_work,routine_work,createAHearingNoticeMT,createAHearingNoticeInt,damagesListCMCMulti,damagesListCCMCMulti,damagesListPTRMulti,damagesListTrialMulti,damagesListCMCInt,damagesListPTRInt,damagesListTrialInt,specifiedListCMCMulti,specifiedListCCMCMulti,specifiedListPTRMulti,specifiedListTrialMulti,specifiedListCMCInt,specifiedListPTRInt,specifiedListTrialInt"}' "ADMIN"
