...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=https://civil-ccd-definition-store-staging-aat.aat.platform.hmcts.net"
echo "export CAMUNDA_BASE_URL=https://civil-ccd-camunda-staging-aat.aat.platform.hmcts.net"

# definition placeholders
echo "export CCD_DEF_CASE_SERVICE_BASE_URL=http://civil-ccd-staging-java"
echo "export CCD_DEF_GEN_APP_SERVICE_BASE_URL=http://civil-ccd-staging-java"
