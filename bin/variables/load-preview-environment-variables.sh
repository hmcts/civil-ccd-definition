...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=http://civil-ccd-pr-1113-ccd-definition-store"
echo "export CAMUNDA_BASE_URL=http://civil-ccd-pr-1113-camunda"

# definition placeholders
echo "export CCD_DEF_CASE_SERVICE_BASE_URL=http://civil-ccd-pr-1113-java"
