...
export const paragraphs = {
  ...
  otherReason: {
    paragraph1:
      'If a Judge has submitted this information, a notification will be sent to the listing officer to look at this case offline.',
    paragraph2:
      'If a legal adviser has submitted this information a notification will be sent to a judge for review.',
  },
};
