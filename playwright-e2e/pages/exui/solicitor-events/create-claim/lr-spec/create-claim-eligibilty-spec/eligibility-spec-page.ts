...
@AllMethodsStep()
export default class CreateClaimSpecEligibilityPage extends ExuiPage(BasePage) {
  async verifyContent() {
    await super.runVerifications([
      ...
      super.expectText(lists.addressRequirement, { exact: true }),
      super.expectText(lists.paymentRequirement),
      super.expectText(lists.languageRequirement),
      super.expectText(lists.additionalAddressRequirement, { exact: true }),
