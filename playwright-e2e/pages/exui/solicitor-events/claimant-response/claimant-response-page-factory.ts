...
import ClaimantResponseSpecLanguagePage from './common/claimant-response-spec-language/claimant-response-spec-language-page.ts';
import ClaimantResponseSpecHearingPage from './common/claimant-response-spec-hearing/claimant-response-spec-hearing-page.ts';
...
import ClaimantResponseSpecStatementOfTruthPage from './common/claimant-response-spec-statementOfTruth/claimant-response-spec-statementOfTruth-page.ts';
import ClaimantResponseSpecSubmitPage from './common/claimant-response-spec-submit/claimant-response-spec-submit-page.ts';
import ClaimantsResponseSpecConfirmPage from './common/claimant-response-spec-confirm/claimants-response-spec-confirm-page.ts';
