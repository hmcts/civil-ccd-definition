...
export const radioButtons = {
  ...
  yes: {
    label: 'Yes',
    selector: '#specRespondent1DQDisclosureOfElectronicDocuments_reachedAgreement_Yes',
  },
  no: {
    label: 'No',
    selector: '#specRespondent1DQDisclosureOfElectronicDocuments_reachedAgreement_No',
  },
};
