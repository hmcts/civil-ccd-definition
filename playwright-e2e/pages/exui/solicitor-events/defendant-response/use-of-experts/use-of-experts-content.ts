...
export const addExpertButton = (defendantNumber: number) => ({
  addNewExpert: {
    title: 'Add new',
    selector: `div[id='respondent${defendantNumber}DQExperts_details'] button[class='button write-collection-add-item__top']`,
  },
});

export const expertDetails2v1 = (defendantNumber: number, expertNumber: number) => ({
  label: 'Expert details',
  fields: {
    firstName: {
      label: 'First name',
      selector: `#respondent${defendantNumber}DQExperts_details_${expertNumber}_firstName`,
    },
    lastName: {
      label: 'Last name',
      selector: `#respondent${defendantNumber}DQExperts_details_${expertNumber}_lastName`,
    },
    email: {
      label: 'Email address',
      selector: `#respondent${defendantNumber}DQExperts_details_${expertNumber}_emailAddress`,
    },
    number: {
      label: 'Phone number',
      selector: `#respondent${defendantNumber}DQExperts_details_${expertNumber}_phoneNumber`,
    },
    fieldOfExpertise: {
      label: 'Field of expertise',
      selector: `#respondent${defendantNumber}DQExperts_details_${expertNumber}_fieldOfExpertise`,
    },
    whyDoYouNeedExpert: {
      label: 'Why do you need this expert',
      selector: `#respondent${defendantNumber}DQExperts_details_${expertNumber}_whyRequired`,
    },
    estimateCost: {
      label: 'Estimated cost',
      selector: `#respondent${defendantNumber}DQExperts_details_${expertNumber}_estimatedCost`,
    },
  },
});
