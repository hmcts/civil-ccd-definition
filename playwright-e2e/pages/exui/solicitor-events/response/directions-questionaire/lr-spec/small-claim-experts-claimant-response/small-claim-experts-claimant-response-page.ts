...
import { inputs, radioButtons } from './small-claim-experts-claimant-response-content.ts';
import partys from '../../../../../../../constants/partys.ts';
import CaseDataHelper from '../../../../../../../helpers/case-data-helper.ts';
import { subHeadings } from '../../common/witnesses/witnesses-content.ts';

@AllMethodsStep()
export default class SmallClaimExpertsClaimantResponsePage extends ExuiPage(BasePage) {
