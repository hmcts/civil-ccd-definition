  ...
  async verifyContent(ccdCaseData: CCDCaseData) {
    await super.runVerifications(
      [
        ...
        super.expectLabel(getCheckboxes(this.claimantDefendantParty).fileDQConfirm.label, {index:0}),
        super.expectText(radioButtons(this.claimantDefendantParty).oneMonthStay.label, {index:0}),
        super.expectText(radioButtons(this.claimantDefendantParty).protocolComplied.label, {index:0}),
      ],
