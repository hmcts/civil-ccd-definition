export const paragraphs = {
  descriptiveText1: 'The Claimant(s) believes that the facts stated in the brief details of claim are true.',
  descriptiveText2: ' am duly authorised by the Claimant(s) to sign this statement.',
  descriptiveText3:
  ...
  descriptiveText4:
    ...
    'Alternatively, you will have the opportunity, on the next screen, ' +
    'to change any of the answers before clicking the "submit" button.',
};
