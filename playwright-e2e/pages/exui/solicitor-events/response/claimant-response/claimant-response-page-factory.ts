...
import SmallClaimExpertsClaimantResponsePage from '../directions-questionaire/lr-spec/small-claim-experts-claimant-response/small-claim-experts-claimant-response-page';
import SmallClaimWitnessesClaimantResponsePage from '../directions-questionaire/lr-spec/small-claim-witnesses-claimant-response/small-claim-witnesses-claimant-response-page';
...
export default class ClaimantResponsePageFactory extends BasePageFactory {
  ...
  get smallClaimExpertsClaimantResponsePage() {
    return new SmallClaimExpertsClaimantResponsePage(this.page);
  }

  get smallClaimWitnessesClaimantResponsePage() {
    return new SmallClaimWitnessesClaimantResponsePage(this.page);
  }
