...
import ConfirmManageStayLiftStayPage from './confirm-manage-stay-lift-stay/confirm-manage-stay-lift-stay-page';
import SubmitManageStayPage from './submit-manage-stay/submit-manage-stay-page';
import ConfirmManageStayRequestUpdatePage from './confirm-manage-stay-request-update/confirm-manage-stay-request-update-page';
