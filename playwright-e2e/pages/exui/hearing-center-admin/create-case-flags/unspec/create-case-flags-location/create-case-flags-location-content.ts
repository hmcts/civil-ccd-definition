...
export const radioButtons = {
  ...
  claimant1LitigationFriend: {
    label: `${CaseDataHelper.buildLitigationFriendData(partys.CLAIMANT_1_LITIGATION_FRIEND).partyName} (Claimant 1 Litigation Friend)`,
  },
  claimant2: {
  ...
  claimant2LitigationFriend: {
    label: `${CaseDataHelper.buildLitigationFriendData(partys.CLAIMANT_2_LITIGATION_FRIEND).partyName} (Claimant 2 Litigation Friend)`,
  },
  defendant1: {
  ...
  defendant1LitigationFriend: {
    label: `${CaseDataHelper.buildLitigationFriendData(partys.DEFENDANT_1_LITIGATION_FRIEND).partyName} (Defendant 1 Litigation Friend)`,
  },
  defendant2: {
  ...
  defendant2LitigationFriend: {
    label: `${CaseDataHelper.buildLitigationFriendData(partys.DEFENDANT_2_LITIGATION_FRIEND).partyName} (Defendant 2 Litigation Friend)`,
  },
  claimantExpert1: {
