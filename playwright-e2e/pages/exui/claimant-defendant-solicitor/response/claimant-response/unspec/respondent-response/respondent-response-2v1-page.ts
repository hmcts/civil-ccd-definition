...
export default class RespondentResponse2v1Page extends ExuiPage(BasePage) {
  async verifyContent(ccdCaseData: CCDCaseData) {
    await super.runVerifications([
      ...
      super.expectYesLabel(radioButtons.proceedWithClaim.yes.selector2v1(partys.CLAIMANT_1)),
      super.expectNoLabel(radioButtons.proceedWithClaim.no.selector2v1(partys.CLAIMANT_1)),
      super.expectYesLabel(radioButtons.proceedWithClaim.yes.selector2v1(partys.CLAIMANT_2)),
      super.expectNoLabel(radioButtons.proceedWithClaim.no.selector2v1(partys.CLAIMANT_2)),
    ]);
  }
