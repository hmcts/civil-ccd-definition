...
import {
  ...
  radioButtons,
  inputs,
} from './fixed-recoverable-costs-intermediate-content.ts';
import StringHelper from '../../../../../../../helpers/string-helper.ts';

@AllMethodsStep()
export default class FixedRecoverableCostsIntermediatePage extends ExuiPage(BasePage) {
  ...
  async verifyContent(ccdCaseData: CCDCaseData) {
    await super.runVerifications(
      [
        ...
        super.expectLegend(radioButtons.fixedRecoverableCosts.label, { count: 1 }),
  ...
  async selectYes() {
    ...
    await super.expectText(radioButtons.complexityBandAgreed.label, { count: 1 });
    await super.clickBySelector(
