...
export default class ServiceAddressFragment extends ExuiPage(BasePage) {
  ...
  async enterAddressManual() {
    ...
    await super.inputTextBySelectorBySelector(
    ...
    await super.inputTextBySelectorBySelector(
      ...
      inputs.postTown.selector(this.solicitorParty),
    );
    await super.inputTextBySelectorBySelector(
      addressData.County,
      inputs.county.selector(this.solicitorParty),
    );
    await super.inputTextBySelectorBySelector(
      addressData.Country,
      inputs.country.selector(this.solicitorParty),
    );
    await super.inputTextBySelectorBySelector(
      addressData.PostCode,
      inputs.postCode.selector(this.solicitorParty),
    );
  }
  ...
  async findAddress(postcode: string, index: number) {
    await super.inputTextBySelectorBySelector(
      postcode,
      inputs.postCodeLookup.selector(this.solicitorParty),
    );
    ...
    await super.selectFromDropdownBySelectorBySelector(
      index,
      dropdowns.addressList.selector(this.solicitorParty),
    );
  }
