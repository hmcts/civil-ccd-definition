...
import {
  ...
  heading1,
} from './notify-claim-details-content';

@AllMethodsStep()
export default class NotifyClaimDetailsFragment extends BasePage {
  async verifyContent(...args: any[]): Promise<void> {
    await super.runVerifications([
      ...
      super.expectSubheading(defendant1Inputs.evidenceDocument.label),
    ]);
  }
  ...
  async continue() {
    await super.clickBySelector(defendant1Buttons.continue.selector);
  }
}
