...
import {
  ...
  subheading1,
  table,
} from './notify-claim-details-check-your-answers-content';

@AllMethodsStep()
export default class NotifyClaimDetailsCheckYourAnswersFragment extends BasePage {
  ...
  async checkDefendant1Answers() {
    ...
    await super.expectText(table.evidenceDocument.defendant1Answer);
  }
  ...
  async checkDefendant2Answers() {
    ...
    await super.expectText(table.evidenceDocument.defendant2Answer);
  }
