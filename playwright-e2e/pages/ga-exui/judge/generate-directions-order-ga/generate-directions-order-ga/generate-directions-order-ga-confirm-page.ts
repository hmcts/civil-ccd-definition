...
import { heading, paragraphs } from './generate-directions-order-ga-confirm-content';

@AllMethodsStep()
export default class GenerateDirectionsOrderGaConfirmPage extends GaExuiPage(BasePage) {
