...
import caseProceedsInCasemanSchemaBuilderComponents from './case-proceeds-in-caseman-schema-builder-components';
...
export default class CaseProceedsInCasemanSchemaBuilder extends BaseSchemaBuilder {
  ...
  protected async buildSchema(caseDataBeforeSubmission?: CCDCaseData): Promise<z.ZodType> {
    ...
    return baseSchema.extend({
      ...caseProceedsInCasemanSchemaBuilderComponents.caseProceedsInCaseman,
    });
  }
}
