...
import ManageContactInformationPageFactory from '../../pages/exui/caseworker-events/manage-contact-information/manage-contact-information-factory';
...
type PageFactoryFixtures = {
  ...
  _manageContactInformationPageFactory: ManageContactInformationPageFactory;
};
...
export const test = base.extend<PageFactoryFixtures>({
  ...
  _manageContactInformationPageFactory: async ({ page }, use) => {
    await use(new ManageContactInformationPageFactory(page));
  }
});
