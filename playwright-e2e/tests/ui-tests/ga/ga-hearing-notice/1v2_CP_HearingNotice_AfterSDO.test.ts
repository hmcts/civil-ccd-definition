...
test.describe('After SDO 1v2 - GA CP - Hearing Notice document', { tag: ['@civil-ccd-nightly'] }, () => {
  test('Claimant Hearing notice - Without notice journey', async ({
    ...
    await DefendantSolicitor2ApiSteps.InitiateGeneralApplication();
