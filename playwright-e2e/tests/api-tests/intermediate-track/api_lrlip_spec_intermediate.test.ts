...
test.describe('1v1 LIP v LIP and LR v LIP spec api journeys', { tag: ['@civil-service-nightly', '@pw-api-intermediate-track', '@civil-service-master', '@civil-service-pr'] }, async () => {
