...
test.describe('Transfer Online Case 1v1 API test - fast claim - unspec', { tag: [] }, async () => {
  test('1v1 unspec full defence - not suitable SDO - Transfer Case', { tag: '@api-not-suitable-sdo' }, async ({
